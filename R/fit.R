...
#' @param nlminb_loops [integer()] Number of times to run \code{stats::nlminb()}
#' optimization.
...
#' Details.
#' @param nlminb_control [list()] See \code{mmmTMBcontrol()}
#'
#' @details
...
#'
#' @return An \code{list()} of class \code{mmmTMB} with elements:
#' \itemize{
